...
func (c *authServiceClient) Register(ctx context.Context, in *User, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedAuthServiceServer) Register(context.Context, *User) (*emptypb.Empty, error) {
